...
public class NinjaDocRedirectFilterTest extends AbstractNinjaDocTest {
	@Override
	protected Map<String, String> getConfigsForTest() {
		Map<String, String> configsForTest = super.getConfigsForTest();
		configsForTest.put("ninjadoc.swagger-ui.filter", "false");
	...
	public void shouldRedirectWithConfigUrlIgnoringQueryParams() throws Exception {
		...
		assertEquals("/swagger-ui/index.html?configUrl=/v3/api-docs/swagger-config&filter=false", URLDecoder.decode(locationHeader, StandardCharsets.UTF_8.name()));
	}
}
