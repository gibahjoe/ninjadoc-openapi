...
public class NinjaDocRedirectQueryParams1Test extends AbstractNinjaDocTest {
	@Override
	protected Map<String, String> getConfigsForTest() {
		Map<String, String> configsForTest = super.getConfigsForTest();
		configsForTest.put("ninjadoc.swagger-ui.display-query-params-without-oauth2", "true");
	...
	public void shouldRedirectWithQueryParamsWithoutOauth2() throws Exception {
		...
		assertEquals("/swagger-ui/index.html?url=/v3/api-docs", URLDecoder.decode(locationHeader, StandardCharsets.UTF_8.name()));
	}
