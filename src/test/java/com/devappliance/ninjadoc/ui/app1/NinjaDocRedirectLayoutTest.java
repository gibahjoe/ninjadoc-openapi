...
public class NinjaDocRedirectLayoutTest extends AbstractNinjaDocTest {
    @Override
    protected Map<String, String> getConfigsForTest() {
        Map<String, String> configsForTest = super.getConfigsForTest();
        configsForTest.put("ninjadoc.swagger-ui.layout", "BaseLayout");
    ...
    public void shouldRedirectWithConfigUrlIgnoringQueryParams() throws Exception {
        ...
        assertEquals("/swagger-ui/index.html?configUrl=/v3/api-docs/swagger-config&layout=BaseLayout", URLDecoder.decode(locationHeader, StandardCharsets.UTF_8.name()));
    }
